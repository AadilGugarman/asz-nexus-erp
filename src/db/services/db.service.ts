...
import { InvoiceRepository, PurchaseInvoiceRepository } from '../repositories/invoice.repository';
...
class DbService {
  ...
  get suppliers():        SupplierRepository        { return this._require(this._suppliers,        'suppliers'); }
  get customers():        CustomerRepository        { return this._require(this._customers,        'customers'); }
  get vehicleArrivals():  VehicleArrivalRepository  { return this._require(this._vehicleArrivals,  'vehicleArrivals'); }
  get invoices():         InvoiceRepository         { return this._require(this._invoices,         'invoices'); }
  get purchaseInvoices(): PurchaseInvoiceRepository { return this._require(this._purchaseInvoices, 'purchaseInvoices'); }
  get payments():         PaymentRepository         { return this._require(this._payments,         'payments'); }
  get settings():         SettingsRepository        { return this._require(this._settings,         'settings'); }
